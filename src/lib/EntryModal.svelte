   	 ...
   	 <div class="modal-content">
            ...
            <div class="row px-5">
                <div class="btn-group mt-2 mb-3" role="group">
                    ...
                    />
                    <label class="btn btn-outline-warning" for="worst">Bad</label>
                    ...
                    />
                    <label class="btn btn-outline-primary" for="worst">Okay</label>
                    ...
                    />
                    <label class="btn btn-outline-info" for="worst">Good</label>
                    ...
                    />
                    <label class="btn btn-outline-success" for="worst">Best</label>
